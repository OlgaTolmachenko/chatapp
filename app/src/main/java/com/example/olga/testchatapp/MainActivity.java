...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (Message message : MessageApp.getInstance().getMessageList()) {
            Log.d("Log2", "Current message in MAIN ACTIVITY : " + message.getMessage());
        }
    ...
    public void onClick(View v) {
        ...
        String SENDER_ID = "1024828317746";
        long messageId = Calendar.getInstance().getTimeInMillis();
        ...
        fm.send(new RemoteMessage.Builder(SENDER_ID + "@gcm.googleapis.com")
                ...
                .addData("message", messageField.getText().toString())
                .build());
        ...
        Log.d("Log2", "Message: " + messageToSend.getMessage() + " " + messageToSend.getUserName() + " " + messageToSend.getMessageTime());
